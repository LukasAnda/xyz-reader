...
public class ArticleListActivity extends AppCompatActivity implements
        LoaderManager.LoaderCallbacks<Cursor>, ArticleInterface, ArticlesAdapter.ArticleListItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.color_accent, R.color.color_accent_alternate);
    ...
    public void onArticlesUpdateFailed(String errorMessage) {
        ...
        }).setActionTextColor(getResources().getColor(R.color.color_accent_alternate)).show();
    }
